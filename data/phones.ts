...
export const PHONE_FLAVOR: Record<string, PhoneFlavor> = {
  serena: {
    ...
    messages: [
      ...
      { me: true, text: "항목 4가 이상해. 배점이 안 맞음.", time: "16:24" },
      { me: false, text: "선생님도 다시 올린대. 일단 기준만 적어두자.", time: "16:26" },
    ],
  ...
  jihyun: {
    ...
    messages: [
      ...
      { me: true, text: "테이핑 새거 있음. 드릴 목적만 먼저 물어보게.", time: "17:04" },
      { me: false, text: "ㅇㅇ 조교님도 오늘은 경로만 본대.", time: "17:05" },
    ],
  ...
  yuri: {
    ...
    threadName: "유리",
    messages: [
      { me: false, text: "잔향 얘기는 단톡에서 하지 마. 만나서.", time: "15:12" },
      { me: true, text: "이미 본 사람 있는 것 같아. 모른 척 했어.", time: "15:18" },
      { me: false, text: "공개 범위 그대로. 학교엔 최소만.", time: "15:20" },
    ],
    notes: ["접촉 5회 / 잔상 12초", "과부하 휴식 17:20", "축복도 비극도 아님"],
    transitLine: "분당선 개포동",
    transitEta: "버스 25분",
  },
  hanbyeol: {
    ...
    threadName: "현장 설명회",
    messages: [
      { me: true, text: "현장 설명회 자리 있으면 같이 가자.", time: "21:08" },
      { me: false, text: "보호대 사이즈 다시 재래. 무릎 아이싱도.", time: "21:11" },
      { me: true, text: "영웅 말고 직업으로 듣는 자리면 됨.", time: "21:13" },
    ],
    notes: ["방어 대열 시야 유지", "착지 각 수정", "설명회 신청 완료"],
    transitLine: "9호선 신논현",
    transitEta: "28분",
  },
  yeonseo: {
    ...
    messages: [
      ...
      { me: false, text: "확률표 다시 그렸대. 운세 해설은 접었음.", time: "18:46" },
      { me: true, text: "숫자는 숫자로만. 네일 리페어 사야 함.", time: "18:47" },
    ],
    notes: ["모의고사 후 단과 조정", "도면 기호 오류 3", "현장직 비율만 보지 않기"],
    transitLine: "9호선 신논현",
    transitEta: "28분",
  },
  songa: {
  ...
  eunyoung: {
    ...
    messages: [
      ...
      { me: true, text: "딥페이크 안내문 가방에 넣어둠. 초상권 범위 축소.", time: "20:18" },
  ...
  myeongjin: {
    ...
    notes: ["매트 교체 확인", "아이스팩 재고", "고득점 리플레이보다 중단 기록"],
    transitLine: "별관 도보",
    transitEta: "6분",
  },
};
